...
public class OpenSearchConsumer {
    ...
    static Logger log = LoggerFactory.getLogger(OpenSearchConsumer.class);
    ...
    public static void main(String[] args) throws IOException {
        ...
        // we need to create the index on OpenSearch if it does't exist already
...
//        String connString = "https://wrjvmb6ymv:fl6ez4dcb@kafka-cource-7854477710.eu-central-1.bonsaisearch.net:443";
